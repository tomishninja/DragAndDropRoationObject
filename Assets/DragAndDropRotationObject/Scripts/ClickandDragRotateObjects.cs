...
namespace ClickAndDragRotation
{
    public class ClickandDragRotateObjects : MonoBehaviour
    {
        ...
        // accessor for the draging bool
        internal bool Dragging {  get { return dragging; } }
        ...
        // A mutiplier for the resulting drag direction
        private int dragDirection = -1;

        // an optional listener
        internal RotationHasBeenSetListener listener;
        ...
        internal void CalculateTheRotationOfAllTheObjects(float rotationAmount)
        {
            // Rotate each object in the array
        ...
        private void DetermineMouseInput()
        {
            ...
            else if (Input.GetMouseButtonUp(0))
            {
                ...
                // if the optional listener exists then tell the manager the user has finsihed roating the object
                if (listener != null)
                    listener.UpdateManager();
            }
        }
